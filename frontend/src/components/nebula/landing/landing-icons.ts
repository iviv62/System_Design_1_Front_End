...
/** Small version of the logo mark used in the footer */
...
/** Sun icon — shown when current theme is dark ("switch to light") */
...
/** Moon icon — shown when current theme is light ("switch to dark") */
...
/** GitHub logo — used in the "Star on GitHub" CTA */
...
/** Star icon — decorative, used next to GitHub star count */
export const starIcon: TemplateResult = html`
  <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
  </svg>`;

/** Generic user / person icon used in the orbit center */
